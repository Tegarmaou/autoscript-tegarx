...
# FUNGSI CEKIP DIMODIFIKASI - BYPASS CHECK
function CEKIP () {
    echo -e "\033[0;32mMelewati Pengecekan IP...\033[0m"
    # Langsung jalankan fungsi setup tanpa cek IP
    domain
    Casper2
}
